...
We read, as input, a file *connect-4.data* in the same directory and output the results of the k-fold test data for the Decision Tree in the file [*decision_tree.txt*](
